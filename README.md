...
### **Một số góp ý với các nhóm**
##### Đề tài 1: 
-	Nhóm 1: có tìm hiểu về kubernets, có file hướng dẫn, đều có thể deloy lên máy khi chạy theo file hướng dẫn, kết quả chạy đúng với yêu cầu của đề tài
-	Mình có góp ý về file readme.md của nhóm 1 đó là bạn thiếu thông tin các thành viên trong nhóm và chỗ thì bạn ghi tiếng anh chỗ thì bạn ghi tiếng việt gây khó chịu khi đọc(Bạn nên để 1 thứ tiếng trong file hướng dẫn thôi)
-	Nhóm 2: file README.md có thông tin về kubernets và hướng dẫn cài đặt đầy đủ
##### Đề tài 2: 
-	Nhóm 2: Code phân chia rõ ràng từng phần dễ đọc và file README.md chia bố cục chưa rõ ràng và chưa giới thiệu về đề tài.
##### Đề tài 3: 
-	Nhóm 1: có file hướng dẫn rõ ràng, có thông tin các thành viên, chạy theo hướng dẫn thì deloy được, demo tốt thỏa yêu cầu các đề tài
-	Nhóm 2: code và file hướng dẫn đầy đủ 
##### Đề tài 4: 
-	Nhóm 1: có file README.md có tên các thành viên hướng dẫn cài đặt đầy đủ có hướng dẫn thêm cách khắc phục lỗi nếu trùng port
##### Đề tài 6: 
-	Nhóm 1: Link github không có hướng dẫn, source code đầy đủ có video demo
-	Nhóm 2: File README.md mô tả còn sơ sài, phần hướng dẫn có để trong file docx nhưng nhóm nên để ngoài file readme.md cho mọi người có thể dễ xem.
##### Đề tài 9: 
-	Nhóm 1: link github không mô tả hướng dẫn, không có tên các thành viên. 
##### Đề tài 11: 
-	Nhóm 1: có tìm hiểu đề tài, có file hướng dẫn, thông tin các thành viên trong nhóm, hình ảnh minh họa và có cả video hướng dẫn.
-	Nhóm 2: không có link git
##### Đề tài 14: 
-	Nhóm 1: có file hướng dẫn chi tiết rõ ràng, chạy deploy được, thỏa mãn các yêu cầu của đề tài
##### Đề tài 15: 
-	Nhóm 1: có file hướng dẫn chi tiết rõ có ứng dụng minh họa, chạy được deploy theo file hướng dẫn
##### Đề tài 16: 
-	Nhóm 1: Có file hướng dẫn đầy đủ kèm hình ảnh minh họa, có tìm hiểu về aws cloud9
##### Đề tài 19: 
Nhóm 1: Có tìm hiểu về AWS DeepRacer, không có hướng dẫn thực hiện.
##### Đề tài 25:
-	Nhóm 1: Có file hướng dẫn rõ ràng chi tiết, chạy demo được, có tìm hiểu về amazon sage maker
##### Đề tài 27:
-	Nhóm 1: Có hướng dẫn chạy và hình ảnh minh họa nhưng chưa giới thiệu đề tài 
##### Đề tài 28: 
-	Nhóm 1: Chưa có hướng dẫn cài đặt và chưa giới thiệu đề tài, source code đầy đủ.
-	Nhóm 2: Có file README.md giới thiệu amazon polly, hướng dẫn cài đặt cụ thể và có hình ảnh minh họa.
